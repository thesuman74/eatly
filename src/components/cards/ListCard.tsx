...
const ListCard: React.FC<ItemCardProps> = ({ data, onAddToCart }) => {
  ...
  return (
    <>
      <section className="rouded-lg flex flex-grow h-32  my-1 mb-4  gap-0 border rounded-md bg-card    w-full  border-b-2  hover:scale-105 transition-all duration-300">
        {/* image section  */}
