    ...
    <RestaurantProvider restaurants={restaurantData}>
      <SidebarProvider>
        ...
        <SidebarInset className="min-w-0 max-w-full overflow-x-hidden bg-primary-foreground">
          <header className="flex h-16   fixed w-full z-20 top-0 shrink-0 items-center gap-2 transition-[width,height] bg-sidebar-primary text-white ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12">
